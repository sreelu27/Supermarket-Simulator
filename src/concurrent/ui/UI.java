...
public class UI {
	...
	public JTextField getTextField_39() {
		return textField_39;
	}
	
	public JTextField getTextField_40() {
		return textField_40;
	}
	
	public JTextField getTextField_41() {
		return textField_41;
	}
	
	public JTextField getTextField_42() {
		return textField_42;
	}
	
	public JTextField getTextField_43() {
		return textField_43;
	}
	
	public JTextField getTextField_44() {
		return textField_44;
	}
	...
	private void initialize() {
		...
		lblCustomers.setBounds(112, 38, 103, 13);
		frmSupermarketSimulator.getContentPane().add(lblCustomers);
		
		lblWaitingTime = new JLabel("Wait Time");
		lblWaitingTime.setBounds(396, 38, 80, 13);
		...
		lblUtilization.setBounds(486, 38, 80, 13);
		frmSupermarketSimulator.getContentPane().add(lblUtilization);
		
		textField_38 = new JTextField();
		textField_38.setColumns(10);
		textField_38.setBounds(477, 61, 67, 19);
		frmSupermarketSimulator.getContentPane().add(textField_38);
		
		textField_39 = new JTextField();
		textField_39.setColumns(10);
		textField_39.setBounds(477, 116, 67, 19);
		frmSupermarketSimulator.getContentPane().add(textField_39);
		
		textField_40 = new JTextField();
		textField_40.setColumns(10);
		textField_40.setBounds(477, 170, 67, 19);
		frmSupermarketSimulator.getContentPane().add(textField_40);
		
		textField_41 = new JTextField();
		textField_41.setColumns(10);
		textField_41.setBounds(477, 226, 67, 19);
		frmSupermarketSimulator.getContentPane().add(textField_41);
		
		textField_42 = new JTextField();
		textField_42.setColumns(10);
		textField_42.setBounds(477, 279, 67, 19);
		frmSupermarketSimulator.getContentPane().add(textField_42);
		
		textField_43 = new JTextField();
		textField_43.setColumns(10);
		textField_43.setBounds(477, 329, 67, 19);
		frmSupermarketSimulator.getContentPane().add(textField_43);
		
		textField_44 = new JTextField();
		textField_44.setColumns(10);
		textField_44.setBounds(477, 381, 67, 19);
		frmSupermarketSimulator.getContentPane().add(textField_44);
